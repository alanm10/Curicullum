...
Route::group(array('domain' => '127.0.0.1'), function () {
    ...
    Route::get('/sponsors', 'ControladorWebSponsor@index');
     Route::get('/descuentos', 'ControladorWebDescuentos@index');
...
/* --------------------------------------------- */
    ...
    /* --------------------------------------------- */
    Route::get('/admin/descuentos', 'ControladorDescuento@index');
    Route::get('/admin/descuento/nuevo', 'ControladorDescuento@nuevo');
    Route::post('/admin/descuento/nuevo', 'ControladorDescuento@guardar');
    Route::get('/admin/descuento/cargarGrilla', 'ControladorDescuento@cargarGrilla')->name('descuento.cargarGrilla');
    Route::get('/admin/descuento/eliminar', 'ControladorDescuento@eliminar');
    Route::get('/admin/descuento/{id}', 'ControladorDescuento@editar');
    Route::post('/admin/descuento/{id}', 'ControladorDescuento@guardar'); 
